...
export default function Crousal() {
  return (
    <div>
      <h1 className="font-bold text-5xl flex justify-center pb-0 pt-5 text-slate-600 sm:text-6xl sm:pb-5">
        Our Facilities
      </h1>
        ...
        <div className="float">
          <div className="marquee-container">
            <div className="marquee ">
              <i className=" fa-heart sm:font-bold">
                <img src={img1} alt="l1" />
              </i>
              <i className=" fa-star">
                <img src={img2} alt="l2" />
