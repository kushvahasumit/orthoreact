            ...
            <section className="pt-5 ">
                <footer className=" ">
                    <div className="flex pl-3 ">
                        <h1 className=" m-4  rounded-xl text-6xl w-48 h-10 xs:hidden"> <img
                            src={hospLogo} alt="Hospital logo"/></h1>

                        <div className="flex-col p-0 m-0 xs:hidden">
                            <div className="pt-5 pl-3  text-3xl"> Renu Jagdish Diagnostic</div>
                            <div className=" pl-3 text-3xl"> And Trauma Centre </div>

                            <div className="pt-3 pl-3 w-72">
                                RJ Ortho Hospital is an Orthopaedic Super Speciality hospital with Trauma and Joint Replacement Center. We
                                are experts in complicated trauma, infected fracture non-union, bone and joint specialization.
                            </div>
                        </div>
                        <div className="pl-5 xs:hidden">
                            <h5 className="text-2xl pt-4">Useful links</h5>
                            <ul className="grid">
                                <li className="pt-2  underline hover:underline-offset-4 hover:text-xl"><a href="index.html">Home</a></li>
                                <div className="hover:underline-offset-4 hover:text-xl">
                                    <li className="pt-2 underline "><a href="physiotherpy.html">Orthopaedic</a></li>
                                    <li className="pt-0 underline "><a href="sono.html">Specialties</a></li>
                                </div>

                                <li className="pt-2 underline hover:underline-offset-4 hover:text-xl"><a href="jprofile.html">Dr
                                    Profile</a></li>
                                <li className="pt-2 underline hover:underline-offset-4 hover:text-xl"><a href="gallery.html">Gallery</a>
                                </li>
                                <li className="pt-2 underline hover:underline-offset-4 hover:text-xl"><a href="contact.html">Contact
                                    Us</a></li>
                            ...
                            <div>
                                ...
                                <div>
                                    <div className="pl-1 pt-4 flex">
                                        ...
                                        <p className="pl-4 ">G.I.C. Road Pithoragarh , Near APTech Pithoragarh</p>
                                    </div>
                            ...
                            <div className="pt-3 pl-6 xs:hidden sm:hidden md:flex">
                                <div className="flex-col pl-1">
                                    ...
                                    <div className="pl-1 pt-1 flex">
                                        ...
                                        <div className="pl-3 pt-2 font-semibold hover:scale-110"><a href="mailto:techjunkies@gmail.com"><p>TechJunkies</p></a></div>
                ...
                <footer className="bg-slate-200 flex place-content-center">
                    <div className="flex place-content-center "><img src={copyRight} alt="copyright" width="25px" />
